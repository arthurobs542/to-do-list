      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-6">
        <div className="flex flex-col sm:flex-row items-center gap-6">
          ...
          <div className="relative">
            ...
            <Button
              size="icon"
              className="absolute -bottom-1 -right-1 w-7 h-7 bg-white dark:bg-slate-700 border-2 border-slate-200 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-600"
            >
              <Camera size={14} />
            </Button>
          </div>
